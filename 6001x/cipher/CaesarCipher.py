    ...
    def build_shift_dict(self, shift):
        ...
        if 0 <= shift < 26:
            ...
            for letter in alpha_lower:
                index += 1
                try:
                    dictionary[letter] = alpha_lower[index+shift]
                except IndexError:
                    dictionary[letter] = alpha_lower[(index+shift)-26]
            index = -1
            for letter in alpha_upper:
                index += 1
                try:
                    dictionary[letter] = alpha_upper[index+shift]
                except IndexError:
                    dictionary[letter] = alpha_upper[(index+shift)-26]
            return dictionary
        else:
            return None
